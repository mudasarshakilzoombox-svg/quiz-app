  ...
  return (
    <div className="w-full max-w-3xl rounded-xl bg-white p-8 text-center shadow-lg">
      ...
      <div className="flex justify-center">
            <Button onClick={onHome} className="text-sm sm:text-base md:text-lg lg:text-xl font-[400]  px-4 py-2 bg-[#dcdedc] border border-black rounded-md  hover:bg-[#9f9f9f] transition-colors cursor-pointer w-[200px]">Go to Home</Button>
      </div>
    </div>
  )
}